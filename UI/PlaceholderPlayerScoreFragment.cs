...
namespace AlhambraScoringAndroid.UI
{
    public class PlaceholderPlayerScoreFragment : PlaceholderPlayerScoreFragmentBase
    {
        ...
        protected override void SetControlsProperties()
        {
            ...
            pavilionCountNumericUpDown.SetNumberRange(0, Game.BuildingsMaxCount[BuildingType.Pavilion], SettingsType.ValidateBuildingsNumber);
            seraglioCountNumericUpDown.SetNumberRange(0, Game.BuildingsMaxCount[BuildingType.Seraglio], SettingsType.ValidateBuildingsNumber);
            arcadesCountNumericUpDown.SetNumberRange(0, Game.BuildingsMaxCount[BuildingType.Arcades], SettingsType.ValidateBuildingsNumber);
            chambersCountNumericUpDown.SetNumberRange(0, Game.BuildingsMaxCount[BuildingType.Chambers], SettingsType.ValidateBuildingsNumber);
            gardenCountNumericUpDown.SetNumberRange(0, Game.BuildingsMaxCount[BuildingType.Garden], SettingsType.ValidateBuildingsNumber);
            towerCountNumericUpDown.SetNumberRange(0, Game.BuildingsMaxCount[BuildingType.Tower], SettingsType.ValidateBuildingsNumber);
            bonusCardsPavilionCountNumericUpDown.SetNumberRange(0, Game.BonusCardsMaxCount[BuildingType.Pavilion], SettingsType.ValidateBonusCards);
            bonusCardsSeraglioCountNumericUpDown.SetNumberRange(0, Game.BonusCardsMaxCount[BuildingType.Seraglio], SettingsType.ValidateBonusCards);
            bonusCardsArcadesCountNumericUpDown.SetNumberRange(0, Game.BonusCardsMaxCount[BuildingType.Arcades], SettingsType.ValidateBonusCards);
            bonusCardsChambersCountNumericUpDown.SetNumberRange(0, Game.BonusCardsMaxCount[BuildingType.Chambers], SettingsType.ValidateBonusCards);
            bonusCardsGardenCountNumericUpDown.SetNumberRange(0, Game.BonusCardsMaxCount[BuildingType.Garden], SettingsType.ValidateBonusCards);
            bonusCardsTowerCountNumericUpDown.SetNumberRange(0, Game.BonusCardsMaxCount[BuildingType.Tower], SettingsType.ValidateBonusCards);
            squaresPavilionCountNumericUpDown.SetNumberRange(0, 9, SettingsType.ValidateSquares);
            squaresSeraglioCountNumericUpDown.SetNumberRange(0, 9, SettingsType.ValidateSquares);
            squaresArcadesCountNumericUpDown.SetNumberRange(0, 9, SettingsType.ValidateSquares);
            squaresChambersCountNumericUpDown.SetNumberRange(0, 9, SettingsType.ValidateSquares);
            squaresGardenCountNumericUpDown.SetNumberRange(0, 9, SettingsType.ValidateSquares);
            squaresTowerCountNumericUpDown.SetNumberRange(0, 9, SettingsType.ValidateSquares);
            streetTradersPavilionCountNumericUpDown.SetNumberRange(0, 7, SettingsType.ValidateCitizens);
            streetTradersSeraglioCountNumericUpDown.SetNumberRange(0, 7, SettingsType.ValidateCitizens);
            streetTradersArcadesCountNumericUpDown.SetNumberRange(0, 7, SettingsType.ValidateCitizens);
            streetTradersChambersCountNumericUpDown.SetNumberRange(0, 7, SettingsType.ValidateCitizens);
            streetTradersGardenCountNumericUpDown.SetNumberRange(0, 7, SettingsType.ValidateCitizens);
            streetTradersTowerCountNumericUpDown.SetNumberRange(0, 7, SettingsType.ValidateCitizens);
            treasuresCountNumericUpDown.SetNumberRange(0, 42, SettingsType.ValidateTreasures);
            unprotectedSidesCountNumericUpDown.SetNumberRange(0, Game.AllTilesCount, SettingsType.ValidateUnprotectedSides);
            unprotectedSidesNeighbouringCountNumericUpDown.SetNumberRange(0, Game.AllTilesCount, SettingsType.ValidateUnprotectedSides);
            bazaarsPointsNumericUpDown.SetNumberRange(0, 192, SettingsType.ValidateBazaarsPoints);
            artOfTheMoorsPointsNumericUpDown.SetNumberRange(0, 147, SettingsType.ValidateCultureCounters);
            falconsBlackNumberNumericUpDown.SetNumberRange(0, 5, SettingsType.ValidateFalcons);
            falconsBrownNumberNumericUpDown.SetNumberRange(0, 5, SettingsType.ValidateFalcons);
            falconsWhiteNumberNumericUpDown.SetNumberRange(0, 5, SettingsType.ValidateFalcons);
            watchtowersNumberNumericUpDown.SetNumberRange(0, 18, SettingsType.ValidateWatchtower);
            medinasNumberNumericUpDown.SetNumberRange(0, 9, SettingsType.ValidateMedin);
            buildingsWithoutServantTileNumericUpDown.SetNumberRange(0, Game.AllBuildingsCount, SettingsType.ValidateServants);
            faceDownFruitsCountNumericUpDown.SetNumberRange(0, 35, SettingsType.ValidateSingleFruits);
            bathhousesPointsNumericUpDown.SetNumberRange(0, (Game.AllTilesCount - 1) * 4 * 6, SettingsType.ValidateBathhouses);
            wishingWellsPointsNumericUpDown.SetNumberRange(0, 24, SettingsType.ValidateFontains);
            animalsPointsNumericUpDown.SetNumberRange(0, 24, SettingsType.ValidateAnimals);
            blackDiceTotalPipsNumericUpDown.SetNumberRange(0, 18, SettingsType.ValidateBlackDicePips);
            extensionsPavilionCountNumericUpDown.SetNumberRange(0, 2, SettingsType.ValidateExtensions);
            extensionsSeraglioCountNumericUpDown.SetNumberRange(0, 2, SettingsType.ValidateExtensions);
            extensionsArcadesCountNumericUpDown.SetNumberRange(0, 2, SettingsType.ValidateExtensions);
            extensionsChambersCountNumericUpDown.SetNumberRange(0, 2, SettingsType.ValidateExtensions);
            extensionsGardenCountNumericUpDown.SetNumberRange(0, 2, SettingsType.ValidateExtensions);
            extensionsTowerCountNumericUpDown.SetNumberRange(0, 2, SettingsType.ValidateExtensions);
            handymenTilesHighestNumberNumericUpDown.SetNumberRange(0, 48, SettingsType.ValidateHandymen);
            treasuresValueNumericUpDown.SetNumberRange(0, 15, SettingsType.ValidateTreasuresPoints);
            mission1RowsCountNumericUpDown.SetNumberRange(0, Game.AllTilesCount / 3, SettingsType.ValidateMissions);
            mission2ColumnsCountNumericUpDown.SetNumberRange(0, Game.AllTilesCount / 3, SettingsType.ValidateMissions);
            mission5LongestDiagonalLineNumericUpDown.SetNumberRange(0, (Game.AllTilesCount + 1) / 2, SettingsType.ValidateMissions);
            mission8PathBuildingsNumberNumericUpDown.SetNumberRange(0, (Game.AllTilesCount + 1) / 2, SettingsType.ValidateMissions);
            secondLongestWallNumericUpDown.SetNumberRange(0, Game.WallsMaxLength / 2 - 2, SettingsType.ValidateSecondLongestWall);
            moatLengthNumericUpDown.SetNumberRange(0, Game.MoatMaxLength, SettingsType.ValidateMoatLength);
            arenaNumericUpDown.SetNumberRange(0, 6, SettingsType.ValidateBuildingsNumber);
            bathHouseNumericUpDown.SetNumberRange(0, 6, SettingsType.ValidateBuildingsNumber);
            libraryNumericUpDown.SetNumberRange(0, 6, SettingsType.ValidateBuildingsNumber);
            hostelNumericUpDown.SetNumberRange(0, 6, SettingsType.ValidateBuildingsNumber);
            hospitalNumericUpDown.SetNumberRange(0, 6, SettingsType.ValidateBuildingsNumber);
            marketNumericUpDown.SetNumberRange(0, 6, SettingsType.ValidateBuildingsNumber);
            parkNumericUpDown.SetNumberRange(0, 6, SettingsType.ValidateBuildingsNumber);
            schoolNumericUpDown.SetNumberRange(0, 6, SettingsType.ValidateBuildingsNumber);
            residentialAreaNumericUpDown.SetNumberRange(0, 6, SettingsType.ValidateBuildingsNumber);
            wallMoatCombinationNumericUpDown.SetNumberRange(0, Math.Min(Game.WallsMaxLength, Game.MoatMaxLength), SettingsType.ValidateMoatwall);
