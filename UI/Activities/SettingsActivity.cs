...
{
    [Activity(Label = "@string/action_settings", Theme = "@style/AppTheme.NoActionBar", MainLauncher = false)]
    public class SettingsActivity : BaseActivity
    {
        ...
        protected override void OnCreate(Bundle savedInstanceState)
        {
            ...
            {
                ScoreLineCheckBoxView checkBox = FindViewById<ScoreLineCheckBoxView>(validationCheckBox.Item1);
                checkBox.Value = Settings.IsSet(validationCheckBox.Item2);
